...
class Reasoning:
    ...
    def reasoning_step(self, query:str, context:str, seq=None, init=True, depth=0, log_dir="log_dir_default"):
        ...
        if "SOLVED" in result:
            log_path = os.path.join(os.getcwd(), log_dir, 'steps', 'output.md')
            os.makedirs(os.path.join(os.getcwd(), log_dir, 'steps')) if not os.path.exists(log_path) else None
        ...
        log_path_steps = os.path.join(os.getcwd(), log_dir, "steps")
